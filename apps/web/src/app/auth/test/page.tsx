      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className={ping.isLoading ? 'text-yellow-600' : ping.isSuccess ? 'text-green-600' : 'text-red-600'}>
              {ping.isLoading ? 'Loading...' : ping.isSuccess ? '✅ Success: ' + JSON.stringify(ping.data) : '❌ Error: ' + ping.error?.message}
            </p>
          </div>
          ...
          <div>
            ...
            <p className={profile.isLoading ? 'text-yellow-600' : profile.isSuccess ? 'text-green-600' : 'text-red-600'}>
              {!session ? '⚪ Not attempted (not signed in)' : profile.isLoading ? 'Loading...' : profile.isSuccess ? '✅ Success: ' + JSON.stringify(profile.data) : '❌ Error: ' + profile.error?.message}
            </p>
          </div>
          ...
          <div>
            ...
            <p className={adminInfo.isLoading ? 'text-yellow-600' : adminInfo.isSuccess ? 'text-green-600' : 'text-red-600'}>
              {!session ? '⚪ Not attempted (not signed in)' : adminInfo.isLoading ? 'Loading...' : adminInfo.isSuccess ? '✅ Success: ' + JSON.stringify(adminInfo.data) : '❌ Error: ' + adminInfo.error?.message}
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Button 
                ...
                disabled={usersCreate.isLoading}
                className="mt-2"
              >
                {usersCreate.isLoading ? 'Testing...' : 'Test Create User'}
              </Button>
            ...
            <div>
              ...
              <Button 
                ...
                disabled={vendorsDelete.isLoading}
                className="mt-2"
              >
                {vendorsDelete.isLoading ? 'Testing...' : 'Test Delete Vendor'}
              </Button>
