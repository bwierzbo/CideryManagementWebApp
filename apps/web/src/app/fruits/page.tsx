          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                ...
                <p>Access denied</p>
                <p className="text-sm">You need appropriate permissions to view fruit varieties</p>
              </div>
            </CardContent>
          </Card>
        </main>
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Manage fruit variety characteristics for cider production
              </p>
            </div>
        ...
        <Card className="bg-white">
          <CardHeader>
            ...
            <CardDescription>
              Comprehensive database of fruit varieties with cider characteristics.
