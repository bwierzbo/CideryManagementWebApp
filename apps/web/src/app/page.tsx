...
import { ShoppingCart, Grape, Beaker, Package, ArrowRight } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              ...
              apple purchases to bottled products with ease and precision.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Comprehensive Cidery Management
            </h2>
            <p className="text-lg text-gray-600">
              Everything you need to run your cidery efficiently
            </p>
          </div>
            ...
            {workflowSteps.map((step, index) => {
              ...
              return (
                <div key={index} className="text-center">
                  <div
                    className={`w-16 h-16 ${step.color} rounded-2xl flex items-center justify-center mx-auto mb-4 border-2`}
                  >
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-6">
              Ready to streamline your cidery operations?
            </p>
            <Button
              size="lg"
              asChild
