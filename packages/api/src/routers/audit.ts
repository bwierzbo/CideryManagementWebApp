...
export const auditRouter = router({
  ...
  getRecordHistory: createRbacProcedure('list', 'audit')
    ...
    .query(async ({ input }) => {
      try {
        ...
        throw new TRPCError({
          code: 'INTERNAL_SERVER_ERROR',
          message: error instanceof Error ? error.message : 'Failed to get record history'
        })
      }
    }),
  ...
  getStats: createRbacProcedure('list', 'audit')
    ...
    .query(async ({ input }) => {
      try {
        ...
        throw new TRPCError({
          code: 'INTERNAL_SERVER_ERROR',
          message: error instanceof Error ? error.message : 'Failed to get audit stats'
        })
      }
    }),
  ...
  validateIntegrity: createRbacProcedure('list', 'audit')
    ...
    .query(async ({ input }) => {
      try {
        ...
        throw new TRPCError({
          code: 'INTERNAL_SERVER_ERROR',
          message: error instanceof Error ? error.message : 'Failed to validate audit integrity'
        })
      }
    }),
  ...
  getSummary: createRbacProcedure('list', 'audit')
    ...
    .query(async ({ input }) => {
      try {
        return await auditQueryService.getAuditSummary(input.startDate, input.endDate)
      } catch (error) {
  ...
  searchLogs: createRbacProcedure('list', 'audit')
    ...
    .query(async ({ input }) => {
      try {
        ...
        throw new TRPCError({
          code: 'INTERNAL_SERVER_ERROR',
          message: error instanceof Error ? error.message : 'Failed to search audit logs'
        })
      }
    }),
  ...
  getTableOperations: createRbacProcedure('list', 'audit')
    .input(z.object({
      ...
      operations: z.array(z.enum(['create', 'update', 'delete', 'soft_delete', 'restore'])).min(1),
      limit: z.number().min(1).max(200).default(50),
    ...
    .query(async ({ input }) => {
      try {
        ...
        throw new TRPCError({
          code: 'INTERNAL_SERVER_ERROR',
          message: error instanceof Error ? error.message : 'Failed to get table operations'
        })
      }
    }),
  ...
  getSuspiciousActivity: createRbacProcedure('list', 'audit')
    .input(z.object({
      ...
      suspiciousPatterns: z.array(z.string()).default(['bulk', 'admin', 'override', 'bypass'])
    }))
    .query(async ({ input }) => {
      try {
        ...
        throw new TRPCError({
          code: 'INTERNAL_SERVER_ERROR',
          message: error instanceof Error ? error.message : 'Failed to get suspicious activity'
        })
      }
    }),
   ...
   */
  getCoverage: createRbacProcedure('list', 'audit')
    .query(async () => {
      try {
