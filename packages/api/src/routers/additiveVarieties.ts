...
export const additiveVarietiesRouter = router({
  ...
  create: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      const { name, itemType, labelImpact, labelImpactNotes, allergensVegan, allergensVeganNotes } = input
  ...
  update: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      const { id, name, itemType, isActive, labelImpact, labelImpactNotes, allergensVegan, allergensVeganNotes } = input
  ...
  getVendorLinks: protectedProcedure
    ...
    .query(async ({ input }) => {
      ...
      const links = await db
        ...
        .leftJoin(additiveVarieties, eq(vendorAdditiveVarieties.varietyId, additiveVarieties.id))
        .where(and(
