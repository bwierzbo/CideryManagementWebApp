...
describe('Financial Utilities', () => {
  ...
  describe('formatPercentage', () => {
    ...
    it('should throw error for invalid decimal places', () => {
      expect(() => formatPercentage(15.5, -1))
        .toThrow('Decimal places must be between 0 and 10')
      expect(() => formatPercentage(15.5, 11))
        .toThrow('Decimal places must be between 0 and 10')
    })

    it('should throw error for non-finite values', () => {
      expect(() => formatPercentage(Infinity))
        .toThrow('Percentage value must be a finite number')
    })
  })
  ...
  describe('roundFinancial', () => {
    ...
    it('should throw error for invalid decimal places', () => {
      expect(() => roundFinancial(123.45, -1))
        .toThrow('Decimal places must be between 0 and 10')
    })

    it('should throw error for non-finite amounts', () => {
      expect(() => roundFinancial(Infinity))
  ...
  describe('calculateWeightedAverage', () => {
    ...
    it('should throw error for empty array', () => {
      expect(() => calculateWeightedAverage([]))
        .toThrow('At least one value is required for weighted average')
    })

    it('should throw error for non-finite values', () => {
      const invalidValues = [{ value: Infinity, weight: 1 }]
      expect(() => calculateWeightedAverage(invalidValues))
        .toThrow('All values and weights must be finite numbers')
    })
    ...
    it('should throw error when all weights are zero', () => {
      ...
      expect(() => calculateWeightedAverage(values))
  ...
  describe('calculateStandardDeviation', () => {
    it('should calculate standard deviation correctly', () => {
      ...
      expect(stdDev).toBeCloseTo(2.1380, 3) // Known result
    })
    ...
    it('should throw error for empty array', () => {
      expect(() => calculateStandardDeviation([]))
        .toThrow('At least one value is required for standard deviation')
    })

    it('should throw error for non-finite values', () => {
      expect(() => calculateStandardDeviation([1, 2, Infinity]))
  ...
  describe('calculateCoefficientOfVariation', () => {
    ...
    it('should throw error for zero mean', () => {
      const values = [-1, 0, 1]
      expect(() => calculateCoefficientOfVariation(values))
        .toThrow('Cannot calculate coefficient of variation when mean is zero')
    })
  ...
  describe('calculateMedian', () => {
    ...
    it('should throw error for empty array', () => {
      expect(() => calculateMedian([]))
        .toThrow('At least one value is required for median calculation')
    })

    it('should throw error for non-finite values', () => {
      expect(() => calculateMedian([1, 2, Infinity]))
        .toThrow('All values must be finite numbers')
    })
  })
  ...
  describe('calculatePercentile', () => {
    ...
    it('should throw error for invalid percentile', () => {
      expect(() => calculatePercentile(values, -1))
        .toThrow('Percentile must be between 0 and 100')
      expect(() => calculatePercentile(values, 101))
        .toThrow('Percentile must be between 0 and 100')
    })

    it('should throw error for empty array', () => {
      expect(() => calculatePercentile([], 50))
        .toThrow('At least one value is required for percentile calculation')
    })
  })
  ...
  describe('calculateCagr', () => {
    ...
    it('should throw error for invalid beginning value', () => {
      expect(() => calculateCagr(0, 100, 5))
        .toThrow('Beginning value must be positive')
      expect(() => calculateCagr(-100, 200, 5))
        .toThrow('Beginning value must be positive')
    })

    it('should throw error for invalid ending value', () => {
      expect(() => calculateCagr(100, 0, 5))
        .toThrow('Ending value must be positive')
    })

    it('should throw error for invalid periods', () => {
      expect(() => calculateCagr(100, 200, 0))
  ...
  describe('isFinanciallyEqual', () => {
    it('should return true for equal amounts', () => {
      expect(isFinanciallyEqual(10.00, 10.00)).toBe(true)
    })

    it('should return true for amounts within default tolerance', () => {
      expect(isFinanciallyEqual(10.00, 10.005)).toBe(true)  // Within penny
      expect(isFinanciallyEqual(10.00, 9.995)).toBe(true)   // Within penny
    })

    it('should return false for amounts outside default tolerance', () => {
      expect(isFinanciallyEqual(10.00, 10.02)).toBe(false)  // 2 cents difference
      expect(isFinanciallyEqual(10.00, 9.98)).toBe(false)   // 2 cents difference
    })

    it('should respect custom tolerance', () => {
      expect(isFinanciallyEqual(10.00, 10.05, 0.1)).toBe(true)   // Within 10 cents
      expect(isFinanciallyEqual(10.00, 10.15, 0.1)).toBe(false)  // Outside 10 cents
    })
    ...
    it('should throw error for non-finite amounts', () => {
      expect(() => isFinanciallyEqual(Infinity, 10))
        .toThrow('Amounts must be finite numbers')
    })

    it('should throw error for negative tolerance', () => {
      expect(() => isFinanciallyEqual(10, 10, -0.01))
  ...
  describe('parseFinancialAmount', () => {
    ...
    it('should throw error for non-finite numbers', () => {
      expect(() => parseFinancialAmount(Infinity))
        .toThrow('amount must be a finite number')
    })

    it('should throw error for invalid types', () => {
      expect(() => parseFinancialAmount(null as any))
        .toThrow('amount must be a string or number')
    })
  })
  ...
  describe('calculateRoi', () => {
    ...
    it('should throw error for zero investment cost', () => {
      expect(() => calculateRoi(100, 0))
        .toThrow('Investment cost cannot be zero')
    })

    it('should throw error for non-finite values', () => {
      expect(() => calculateRoi(Infinity, 1000))
        .toThrow('Gain and cost must be finite numbers')
    })
  })
  ...
  describe('calculateBreakEvenUnits', () => {
    ...
    it('should always round up to whole units', () => {
      const units = calculateBreakEvenUnits(100, 15, 14.50) // Contribution = $0.50, 100/0.5 = 200
    ...
    it('should throw error for negative fixed costs', () => {
      expect(() => calculateBreakEvenUnits(-1000, 15, 8))
        .toThrow('Fixed costs must be non-negative')
    })

    it('should throw error for invalid price per unit', () => {
      expect(() => calculateBreakEvenUnits(1000, 0, 8))
        .toThrow('Price per unit must be positive')
      expect(() => calculateBreakEvenUnits(1000, -15, 8))
        .toThrow('Price per unit must be positive')
    })

    it('should throw error for negative variable cost', () => {
      expect(() => calculateBreakEvenUnits(1000, 15, -5))
        .toThrow('Variable cost per unit must be non-negative')
    })

    it('should throw error when variable cost equals or exceeds price', () => {
      expect(() => calculateBreakEvenUnits(1000, 15, 15))
        .toThrow('Price per unit must be greater than variable cost per unit')
      expect(() => calculateBreakEvenUnits(1000, 15, 20))
        .toThrow('Price per unit must be greater than variable cost per unit')
    })
  })
  ...
  describe('Financial Integration Tests', () => {
    ...
    it('should validate pricing strategy calculations', () => {
      ...
      // Break-even analysis
      const breakEvenUnits = calculateBreakEvenUnits(25000, sellingPrice, cogsCost)
