...
export const CIDER_CATEGORY = ['sweet', 'bittersweet', 'sharp', 'bittersharp'] as const
export const INTENSITY = ['high', 'medium-high', 'medium', 'low-medium', 'low'] as const
export const HARVEST_WINDOW = ['Late', 'Mid-Late', 'Mid', 'Early-Mid', 'Early'] as const
