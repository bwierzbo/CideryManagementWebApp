...
export const isoDateStringSchema = z
  .string()
  .datetime("Invalid ISO date string");
...
export const cogsItemTypeSchema = z.enum([
  "apple_cost",
  "labor",
  "overhead",
  "packaging",
...
export const createAppleVarietySchema = z.object({
  ...
  typicalBrix: z
    .number()
    .min(0)
    .max(30, "Brix must be between 0 and 30")
    .optional(),
...
export const createPressRunSchema = z.object({
  ...
  extractionRate: z
    .number()
    .min(0)
    .max(1, "Extraction rate must be between 0 and 1")
    .optional(),
  items: z
    .array(createPressItemSchema)
...
export const createBatchSchema = z.object({
  ...
  targetAbv: z
    .number()
    .min(0)
    .max(20, "ABV must be between 0 and 20")
    .optional(),
  actualAbv: z
    .number()
    .min(0)
...
export const createPackagingRunSchema = z.object({
  ...
  bottleSize: z
    ...
    .max(20, "Bottle size too long"),
  bottleCount: z
    .number()
    .int()
    .positive("Bottle count must be a positive integer"),
  abvAtPackaging: z
    .number()
    .min(0)
    .max(20, "ABV must be between 0 and 20")
...
export const createMeasurementSchema = z.object({
  ...
  specificGravity: z
    .number()
    .min(0.98)
    .max(1.2, "Specific gravity must be between 0.980 and 1.200")
    .optional(),
  ...
  totalAcidity: z
    .number()
    .min(0)
    .max(5, "Total acidity must be between 0 and 5")
    .optional(),
  temperature: z
    .number()
    .min(-10)
    .max(50, "Temperature must be between -10 and 50°C")
    .optional(),
