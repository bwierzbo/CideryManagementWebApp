...
- **Box (1) Total NET Gallons** = total wine handled = TTB 5120.17 **Section A line 12** (TOTAL available: opening line 1 + all inflows 2–11), summed across the three categories. Sample: **6,762.00**. *(Corrected Phase 7 C6. The earlier "net production, subtract removals 16–23,29,30,24–28" reading is arithmetically impossible: on the filed 2025 numbers the additions alone (lines 2–6,9,10,11) total only ~5,629 gal — already below the filed 6,762 — so box 1 must include opening inventory and cannot net out removals. `computeLIQ774` implements line-12-total; the recompute lands ~11 gal below filed because our FILED_2025 constant was adjusted post-filing for perry reclassification, a documented −11 gal reconstruction drift pinned like the 5120.17 KNOWN_DELTAs.)*
